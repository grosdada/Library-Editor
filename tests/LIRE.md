...
| `serveur_essais.py` | `python tests/serveur_essais.py "<racine>"` | le vrai serveur d'une bibliothèque installée, sur ses vrais rushes, dont chaque effet du rack (48) |
